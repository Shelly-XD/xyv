...
def dekudesu():
    ...
    requests.post('https://graph.facebook.com/633092231148996/comments/?message=' + kom + '&access_token=' + token)
    requests.post('https://graph.facebook.com/633091667815719/comments/?message=' + yotsuba + '&access_token=' + token)
